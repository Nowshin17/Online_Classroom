    ...
    <div>
        <div className='background-color alignItem'>
            <div class="bg-[#F6F8F7] ">
                ...
                <div class="text-[#ff6752] text-1xl font-semibold text-center pt-16"> What we offer</div>
                <div class="bg-[#F6F8F7] text-4xl font-bold text-center pt-1"> For Tour Future Learning.</div>
